...
clean:			## Clean output files.
			...
			rm -f Main.aux Main.glo  Main.lol Main.toc Main.bbl Main.gls Main.lot Main.acn  Main.blg Main.ist Main.out Main.acr Main-blx.bib Main.lof Main.run.xml Main.alg  Main.glg Main.log
