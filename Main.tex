...
% , spanish, es-noshorthands, es-tabla]{babel}
...
pellentesque lacus. Aliquam sit amet est nec nisl\cite{test} cursus varius. Sed pharetra ac
neque quis imperdiet. Quisque ac tortor enim. Sed dignissim blandit orci, id
fermentum lorem commodo eget\cite{Recos}.\cite{test}
