    ...
    % TODO no me gusta
        ...
        \centering
            \begin{tabular}{||p{0.2\linewidth} | p{0.5\linewidth} | p{0.4\linewidth}||} 
                 \hline
                 Repository Name & URL  & Description \\ [0.5ex] 
                 \hline\hline
                 alastria-wallet & \url{https://github.com/alastria/alastria-wallet} & IONIC application for the final users to opearate with their Alastria Identity \\ 
                 \hline
                 alastria-identity & \url{https://github.com/alastria/alastria-identity} & It contains the truffle project with the Smart Contracts written in Solidity \\
                 \hline
                 alastria-identity-lib & \url{https://github.com/alastria/alastria-identity-lib} & Library written in TypeScript to facilitate interaction with Smart Contracts \\
                 \hline
                 alastria-identity-example & \url{https://github.com/alastria/alastria-identity-example} & Examples of use to interact with the library\\
                 \hline
                 alastria-JSON-objects &  \url{https://github.com/alastria/alastria-identity-JSON-objects} & Alastria ID Model specification JSON objects verification \\ 
                 \hline
                 alastria-identity-entity & \url{https://github.com/alastria/alastria-identity-entity} & Example of an entity application with Alastria ID \\ 
                 \hline
                 alastria-node & \url{https://github.com/alastria/alastria-node} & Scripts for the installation of a blockchain node in Alastria\\ [1ex] 
                 \hline
            \end{tabular}
            \caption{Main repositories in Alastria's GitHub}
        \end{table}
        \subsubsection{Smart Contracts}
