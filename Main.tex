        ...
        \subsubsection{Mythril analysis}
            ...
            \begin{figure}[h]
                ...
                \begin{tikzpicture}
                    ...
                    \addplot coordinates {
                        (AlastriaCredentialRegistry, 6)
                        (AlastriaIdentityEntity, 7)
            ...
            In conclusion to the analysis, we can see that Smart Contracts \textit{AlastriaIdentityEntity} and \textit{AlastriaCredentialRegistry} are the ones that have found the most vulnerabilities, with seven and six respectively (figure \ref{fig:bars-scs}). In relation to the vulnerabilities found, we see that \textbf{47.6\% are high}, another \textbf{47.6\% are medium} and\textbf{ 4.8\% are low} (figure \ref{fig:pie-scs}).
            \begin{figure}[h]
                \centering
                \begin{tikzpicture}
                    \pie{47.6/High, 47.6/Medium, 4.8/Low}
                \end{tikzpicture}
