...
\section{State of the Art}
    ...
    \subsection{Ethereum}
        ...
        \subsubsection{Solidity}
            ...
            \footnotetext[1]{Source code from AlastriaIdentityIssuer.sol\cite{AlastriaIdentityIssuer}}
            \footnotetext[2]{More details about Solidity can be found in the official documentation\cite{solidity}}
    ...
    \subsection{JSON-RPC}
        ...
        \subsection{Self-Sovereign Identity}
            ...
            % https://tykn.tech/self-sovereign-identity/#Models_of_Digital_Identity
