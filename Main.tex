...
\section{State of the Art}
    ...
    \subsection{Ethereum}
        ...
        \subsubsection{Solidity}
            ...
            Below is an example of a Smart Contract written in Solidity (listing  \ref{lst:AlastriaIdentityIssuer}).
            
            \lstinputlisting[label={lst:AlastriaIdentityIssuer}, caption=Source code from AlastriaIdentityIssuer\cite{AlastriaIdentityIssuer}, language=Solidity]{examples/SmartContracts/AlastriaIdentityIssuer.sol}
            % TODO quitar el enlace en la tabla de contenido
            
            More details about Solidity can be found in the official documentation\cite{solidity}.
    ...
    \subsection{JSON-RPC}
        ...
        \subsubsection{RPC}
            ...
            \paragraph{How RPC works}
                ...
                In the next figure (figure \cite{fig:rpc_schema}) we can see the typical RPC communication schema.
                \begin{figure}[h]
                    \centering
        ...
        \subsubsection{JSON-RPC 2.0}
            ...
            \begin{itemize}
                \item \textbf{sonrpc}: The version of the JSON-RPC protocol. It must be exactly “2.0”.
        ...
        \subsection{Self-Sovereign Identity}
            % TODO resumen "intenso"
            \subsubsection{Alastria ID}
                % TODO Resumen de alastria ID y mencionar el punto importante 
            \subsubsection{Other implementations}
                % TODO resumen de otras, como UPORT
\newpage

\section{Alastria ID}
% TODO cuerpo del trabajo
